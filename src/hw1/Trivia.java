...
public class Trivia {
	...
	public static void main(String[] args) {
		...
		System.out.println("The number of free late days you get throughout the semester is " + lateDays);
		...
		System.out.println(
				"A project I would like to program soon, is to control servo motors. I would also like to learn to code into my computers teermial for problems");
